...
Layers can be added at runtime by using the [`addLayer`](https://ej2.syncfusion.com/documentation/api/diagram/#addlayer) public method.
...
Layers can be removed at runtime by using the [`removeLayer`](https://ej2.syncfusion.com/documentation/api/diagram/#removelayer) public method.
...
Objects of the layers can be moved by using the [`moveObjects`](https://ej2.syncfusion.com/documentation/api/diagram/#moveobjects) public method.
...
Layers can be moved forward at runtime by using the [`bringLayerForward`](https://ej2.syncfusion.com/documentation/api/diagram/#bringlayerforward) public method.
...
Layers can be moved backward at runtime by using the [`sendLayerBackward`](https://ej2.syncfusion.com/documentation/api/diagram/#sendlayerbackward) public method.
...
Layers can be cloned with its object by using the [`cloneLayer`](https://ej2.syncfusion.com/documentation/api/diagram/#cloneLayer) public method.
...
To get the active layers back in diagram, use the [`getActiveLayer`](https://ej2.syncfusion.com/documentation/api/diagram/#getactivelayer) public method.
...
Set the active layer by using the [`setActiveLayer`](https://ej2.syncfusion.com/documentation/api/diagram/#setactivelayer) public method.
