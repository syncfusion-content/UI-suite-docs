...
The diagram is serialized as string while saving. The client-side method, [`saveDiagram`](https://ej2.syncfusion.com/documentation/api/diagram/#savediagram) helps to serialize the diagram as a string.
...
Diagram is loaded from the serialized string data by client-side method, [`loadDiagram`](https://ej2.syncfusion.com/documentation/api/diagram/#loaddiagram).
