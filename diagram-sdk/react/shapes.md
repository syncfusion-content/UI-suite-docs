...
To create an image node, set the shape property to [`image`](https://helpej2.syncfusion.com/react/documentation/api/diagram/imagemodel) and specify the image source through the source property.
...
Set the shape property to [`Html`](https://helpej2.syncfusion.com/react/documentation/api/diagram/htmlmodel) to create HTML nodes. You can define content using either inline templates or external node templates.
...
To render an HTML node with a content template, we need to define the desired template string within the [`content`](https://helpej2.syncfusion.com/react/documentation/api/diagram/htmlmodel#content) property. The following code illustrates how to create an HTML node with a content template:
...
To create a [`native`](https://helpej2.syncfusion.com/react/documentation/api/diagram/nativemodel) node, set the shape property to **native** and provide SVG content through the content property.
...
To create a [`Path`](https://helpej2.syncfusion.com/react/documentation/api/diagram/pathmodel) node, set the shape property to **path** and define the geometry through the [`data`](https://helpej2.syncfusion.com/react/documentation/api/diagram/pathModel#data) property using standard SVG path syntax.
...
To create [`flow`](https://helpej2.syncfusion.com/react/documentation/api/diagram/flowshapemodel) shapes, set the shape type to **flow** and specify the desired flow shape variant. The default flow shape is **process**.
