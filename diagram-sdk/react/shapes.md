...
To create an image node, set the shape property to [`image`](https://ej2.syncfusion.com/react/documentation/api/diagram/imagemodel) and specify the image source through the source property.
...
Set the shape property to [`Html`](https://ej2.syncfusion.com/react/documentation/api/diagram/htmlmodel) to create HTML nodes. You can define content using either inline templates or external node templates.
...
To render html node with nodeTemplate we need to define the nodeTemplate in the html file and assign it to the [`nodeTemplate`](https://ej2.syncfusion.com/react/documentation/api/diagram#nodetemplate) property of the diagram. The following code illustrates how to render html node with nodeTemplate.
...
To create a [`native`](https://ej2.syncfusion.com/react/documentation/api/diagram/nativemodel) node, set the shape property to **native** and provide SVG content through the content property.
...
To create [`Basic`](https://ej2.syncfusion.com/react/documentation/api/diagram/basicshapemodel) shapes, set the type property to **basic** and choose from the available built-in shapes. For rounded rectangles, use the [`cornerRadius`](https://ej2.syncfusion.com/react/documentation/api/diagram/basicShapeModel#cornerradius) property to specify the radius.
...
To create a [`Path`](https://ej2.syncfusion.com/react/documentation/api/diagram/pathmodel) node, set the shape property to **path** and define the geometry through the [`data`](https://ej2.syncfusion.com/react/documentation/api/diagram/pathModel#data) property using standard SVG path syntax.
...
To create [`flow`](https://ej2.syncfusion.com/react/documentation/api/diagram/flowshapemodel) shapes, set the shape type to **flow** and specify the desired flow shape variant. The default flow shape is **process**.
