...
The [`getNodeDefaults`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#getnodedefaults) property in the EJ2 Diagram control allows you to define default settings for nodes based on specific conditions or requirements.
...
The appearance of a node can be customized by changing its [`fill`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shapeStyleModel#fill) color, [`strokeDashArray`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shapeStyleModel#strokedasharray), ['strokeWidth'](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shapeStyleModel#strokewidth), ['strokeColor'](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shapeStyleModel#strokecolor) and [`opacity`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shapeStyleModel#strokecolor). The [`visible`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/node#visible) property of the node enables or disables the visibility of the node.
...
The [`gradient`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/gradientmodel) property of the node allows you to define and apply the gradient effect to that node.
...
* [`LinearGradient`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/lineargradientmodel) defines a smooth transition between a set of colors (so-called stops) on a line.
...
* [`RadialGradient`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/radialgradientmodel) defines a smooth transition between stops on a circle.
...
- `Rotate angle`: The [`rotateAngle`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodemodel#rotateangle) property allows you to rotate nodes within the diagram. It's particularly useful when you want to represent nodes from different perspectives or angles.

- `Corner radius`: The [`cornerRadius`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/basicshapemodel#cornerradius) property allows you to round the corners of nodes in the diagram.
...
Diagram provides support to add [`shadow`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodemodel#shadow) effect to a node that is disabled, by default. It can be enabled with the constraints property of the node. The following code illustrates how to drop shadow.
...
The [`angle`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shadowmodel#angle), [`distance`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shadowModel#distance), and [`opacity`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/shadowModel#opacity) of the shadow can be customized with the `shadow` property of the node. The following code example illustrates how to customize shadow.
...
The [`addInfo`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodeModel#addinfo) property of the node allows you to maintain additional information to the node. You can specify either object or string value.
...
The [`constraints`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodemodel#constraints) property of the node allows you to enable/disable certain behaviors of the node. For more information about node constraints refer to the [`Node Constraints`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodeconstraints)

## Stack order

The nodes [`zIndex`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/nodeModel#zindex) property specifies the stack order of the node. A node with greater stack order is always in front of a node with a lower stack order.
...
Node rotation angle will be based on [`Pivot`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/pointModel) values which range from 0 to 1 like offset values. By default, the Pivot values are set to X= 0.5 and Y=0.5.
...
Node has the InEdges and OutEdges read-only property. In this property, you can find what are all the connectors that are connected to the node, and then you can fetch these connectors by using the [`getObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#getobject) method in the diagram.
