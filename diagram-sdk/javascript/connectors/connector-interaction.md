...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-Select" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-Drag" %}
...
You can also update the endPoints of diagram by using [`dragSourceEnd`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#dragsourceend) and [`dragTargetEnd`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#dragtargetend) methods of diagram. 
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-EndPointDrag" %}


## Segment editing

Diagram allows you to edit connector segments at runtime. To enable this feature, you need to activate the [`DragSegmentThumb`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/connectorConstraints) constraint for the connector.
...
The diagram Provides support to flip the connector. The [`flip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/connector#flip) is performed to give the mirrored image of the original element.

The flip types are as follows:

* HorizontalFlip
 [`Horizontal`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/flipDirection) is used to interchange the connector source and target x points.

* VerticalFlip
[`Vertical`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/flipDirection) is used to interchange the connector source and target y points.

* Both
[`Both`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/flipDirection) is used to interchange the source point as target point and target point as source point
.
{% tabs %}
{% highlight js tabtitle="index.js" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/connectors-cs20" %}
