...
Diagram provides some default context menu items to ease the execution of some frequently used commands. The [`show`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuSettingsModel#show) property helps you to enable/disable the context menu. The following code illustrates how to enable the default context menu items.
...
Context menus can be customized for individual nodes by defining specific menu items beyond the default options. To add additional context menu items, you need to define and incorporate them into the [`items`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextmenuitemmodel#items) property of the context menu.

Each custom item can be defined with specific text and ID using the [`text`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#text) and [`ID`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#id) properties, respectively. Additionally, you can enhance visual cues by associating icons through the [`iconCss`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#iconcss) for enabling the use of font icons. The [`target`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#target) property specifies where each menu item should appear, and separators can be included using the [`separator`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#separator) property to visually group menu items. This flexibility allows for a tailored user interface that meets specific application needs efficiently. Nested menu items are defined within the [`items`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#items) property of a parent menu item.

### To Display custom menu alone

To display the custom context menu items alone, set the [`showCustomMenuOnly`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuSettingsModel#showcustommenuonly) property to true.
...
In certain situations, you may want to hide specific menu items based on the selected elements in the diagram. This can be achieved using the [`contextMenuOpen`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramBeforeMenuOpenEventArgs) event. When the context menu is opened via right-click, the `contextMenuOpen` event is triggered. Within this event, you can create an array of menu items to hide for the selected element and pass it to the [`hiddenItems`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramBeforeMenuOpenEventArgs#hiddenitems) property of the contextMenuOpen event argument. The following example demonstrates how to display different custom menu items for nodes, connectors, and the diagram based on the selection.
...
[`url`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/contextMenuItemModel#url) property of the menu item is used to set the url of any website which will be opened upon clicking on them. The following example shows the context menu with url for three websites.
...
Diagram provides template support for the context menu. The template for the context menu items can be customized before rendering by using the [`contextMenuBeforeItemRender`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#contextmenubeforeitemrender) event, which triggers while rendering each menu item.
...
|Event|Description|
|----|----|
|[`contextMenuBeforeItemRender`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#contextmenubeforeitemrender)|Triggers while initializing each menu item.|
|[`contextMenuOpen`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#contextmenuopen)|Triggers upon right-click before opening the context menu.|
|[`contextMenuClick`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#contextmenuclick)|Triggers when a menu item is clicked.|
