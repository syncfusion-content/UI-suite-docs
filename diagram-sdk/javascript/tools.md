...
To draw a shape, set the JSON of that shape to the [`drawingObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#drawingobject) property of the diagram and activate the drawing tool by using the [`tool`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tool) property. The following code example illustrates how to draw a rectangle at runtime:
...
To draw connector, set the JSON of that connector to the [`drawingObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#drawingobject) property of the diagram. The drawing tool can be activated by using the [`tool`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tool) property. The following code example illustrates how to draw different types of connector using drawing tool.
...
To draw a polygon shape, you need to set the [`drawingObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#drawingobject) property with the appropriate JSON configuration for a `polygon`. This includes specifying the type as **Polygon**.
...
To draw a polyline connector, set the type of the [`drawingObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#drawingobject) as **Polyline**.
...
The segments of a polyline connector can be adjusted at runtime by dragging the segment thumb, as shown in the image below. To enable segment editing, you should set the [`DragSegmentThumb`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/connectorConstraints) constraint for the connector.

![Polyline connector drawing](images/polyline-draw.gif)

N> To make the segment thumb visible, inject the [`ConnectorEditing`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/connectorEditing) module into the diagram.

### Freehand Drawing

The diagram supports free-hand drawing, allowing users to draw anything independently on the diagram page. Free-hand drawing is enabled by setting the type of the [`drawingObject`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#drawingobject) property to **Freehand**.
...
The segments of a freehand connector can be adjusted at runtime by dragging the segment thumb, as shown in the image below. To enable segment editing, you should set the [`DragSegmentThumb`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/connectorConstraints) constraint for the connector.
...
To activate panning mode set the [`tool`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tool) property of the diagram as **ZoomPan**. The following code illustrates how to enable Zoom pan in the diagram
...
The [`elementDraw`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/iElementDrawEventArgs) event is triggered whenever a node or connector is drawn using a drawing tool in the diagram. This event provides a way to capture and respond to actions when elements are created on the canvas.
