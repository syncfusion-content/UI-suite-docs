...
A group can be added to the diagram model through [`nodes`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#nodes) collection. To define an object as group, add the child objects to the [`children`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/node#children) collection of the group. The following code illustrates how to create a group node.
...
Group node can be unGrouped dynamically, by using the [`diagram.unGroup`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#ungroup) method. The following code example shows how to unGroup group node at runtime.
...
A group node can be added at runtime by using the diagram method [`add`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#add).
...
A child node can be added to the specified Group at runtime by utilizing the diagram method [`addChildToGroup`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#addchildtogroup).
...
A specific child from a group node can be removed at runtime by utilizing the diagram method [`removeChildFromGroup`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#removechildfromgroup).
...
The [`Padding`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/node#padding) property of a group node defines the spacing between the group node’s edges and its children.
...
The [`flipMode`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/flipMode) of a group node also behave similarly to those of normal nodes. However,When you apply a flip mode to a group node, it takes precedence over any flip mode set on its child nodes, overriding their individual settings.
...
* It controls spacing by setting margin properties of child and padding properties of group. By default, a stack panel’s [`orientation`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/stackPanel#orientation) is vertical.
