...
A class defines a group of objects that share common specifications, features, constraints, and semantics. To create a class object, the classifier should be defined using the [class](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassifierShapeModel#class) notation. This notation serves as a foundational element in object-oriented programming, encapsulating the Essential<sup style="font-size:70%">&reg;</sup> characteristics and behaviors that objects belonging to the class will exhibit. 

Also, define the [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassModel#name), [`attributes`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassModel#attributes), and [`methods`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassModel#methods) of the class using the class property of node.

The attribute’s [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassAttributeModel#name), [`type`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassAttributeModel#type), and [`scope`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassAttributeModel#scope) properties allow you to define the name, data type, and visibility of the attribute.

The method’s [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassMethodModel#name), [`parameters`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassMethodModel#parameters), [`type`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassMethodModel#type), and [`scope`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassMethodModel#scope) properties allow you to define the name, parameter, return type, and visibility of the methods.

The method [`parameters`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/methodArgumentsModel) property allow you to define the name,type and style of the parameter.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs1" %}

### Interface

An [interface](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassifierShapeModel#interface) is a specific type of classifier that signifies a declaration of a cohesive set of public features and obligations. When creating an interface, you define the classifier property using the interface notation. This foundational concept in object-oriented programming outlines a contract for classes to adhere to, specifying the required methods and behaviors without delving into the implementation details.

Additionally, you can define the [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlInterfaceModel#name), [`attributes`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlInterfaceModel#attributes), and [`methods`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlInterfaceModel#methods) of the interface using the interface property of the node. 
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs2" %}

### Enumeration

To establish an enumeration, designate the classifier property of the node as [enumeration](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlClassifierShapeModel#enumeration). Additionally, define the [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlEnumerationModel#name) and enumerate the [`members`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlEnumerationMemberModel) of the enumeration using the appropriate enumeration property of the node. This process encapsulates a set of distinct values within the enumeration, allowing for a clear representation of specific and named constants within a system.

You can set a name for the enumeration members collection using the [`name`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlEnumerationMemberModel#name) property of the members collection.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs3" %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs4" %}

### Aggregation

`Aggregation` is a binary association between a property and one or more composite objects that group together a set of instances. Aggregation is decorated with a hollow diamond. To create an aggregation shape, define the [`relationship`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/relationShipModel#relationship) of connector shape as “Aggregation”.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs5" %}

### Composition

Composition is a strong form of `aggregation`. The composition is decorated with a black diamond. To create a composition shape, define the [`relationship`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/relationShipModel#relationship) property of the connector shape as "Composition".
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs6" %}
...
To create an inheritance, define the [`relationship`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/relationShipModel#relationship) as “inheritance”.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs8" %}

### Dependency

Dependency is a directed relationship, which is used to show that some UML elements need or depend on other model elements for specifications. Dependency is shown as a dashed line with an opened arrow. To create a dependency, define the [`relationship`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/relationShipModel#relationship) property of the connector shape as “dependency”.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs7" %}
...
The shape multiplicity’s [`source`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/classifierMultiplicityModel#source) property is used to set the source label to the connector and the [`target`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/classifierMultiplicityModel#target) property is used to set the target label to the connector.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs9" %}
...
The [addChildToUmlNode](https://ej2.syncfusion.com/javascript/documentation/api/diagram#addchildtoumlnode) method is employed for dynamically adding a child to the UML node during runtime, providing flexibility in modifying the diagram structure programmatically.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-addDynamic" %}
...
UML built-in shapes are easily rendered in a symbol palette. The [`symbols`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/paletteModel#symbols) property of [`palettes`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/paletteModel) is used to define UML symbols with the necessary classes and methods. This feature allows you to add a collection of predefined UML symbols to the palette, making your UML diagramming application more versatile.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs12" %}
...
To create a UmlActivity, define the [`type`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlActivityShapeModel#type) as "UmlActivity" and set the list of built-in shapes in the [`shape`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/umlActivityShapeModel#shape) property as demonstrated below.
...
{% previewsample "https://help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/help.syncfusion.com/code-snippet/diagram-sdk/javascript/umldiagramshapes-cs11" %}