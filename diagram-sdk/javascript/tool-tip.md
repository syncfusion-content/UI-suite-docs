...
The default tooltip that appears while interacting with nodes can be disabled by removing the tooltip constraints from the [`selectorConstraints`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/selectorconstraints) of the [`selectedItems`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/selectormodel) property of the diagram.
...
The tooltip can be customized for each node and connector. To show different tooltips for different diagram elements on mouse over, set the [`tooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel) property of the node or connector with the tooltip [`content`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#content) and [`position`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#position). The following code example illustrates how to customize the tooltip for individual elements.
...
The tooltip on mouse over can be disabled by setting the diagram's [`tooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tooltip) property to `null`. The following code example illustrates how to disable the mouse over tooltip at runtime.
...
To display tooltips on mouseover, set the desired tooltip [`content`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltip#content) by utilizing the [`tooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tooltip) property.

Tooltips for Ports can be enabled or disabled using the [`PortConstraints`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/port#constraints) Tooltip property.
...
The diagram supports displaying a tooltip around the node or connector that is hovered over by the mouse. The tooltip's alignment can be adjusted using the [`position`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltip#position) property.  The [`relativeMode`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltip#relativemode) property specifies whether the tooltip should be displayed around the object or at the mouse position.
...
To display the tooltip at the mouse position, set the **mouse** option in the [`relativeMode`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltip#relativemode) property of the tooltip.
...
To animate the tooltip, you can use a range of animation effects controlled by the [`animation`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltip#animation) property. This property allows you to customize the delay, duration, and various other effects according to your preferences.
...
A sticky tooltip will remain visible even after you move the mouse away from the node or connector. You can activate this feature by setting the [`isSticky`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#issticky) property of the tooltip. 
...
The [`showTipPointer`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#showtippointer) property allows to control the visibility of tooltip pointer. By default, the `showTipPointer` is set as true.
...
By default, the size of the tooltip is calculated based on its content. If you want to customize the size, you can use the  [`width`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#width) and [`height`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/diagramTooltipModel#height) properties of the tooltip.
...
You can show or hide the tooltip dynamically using a button click with the [`showTooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#showtooltip) and [`hideTooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#hidetooltip) methods of the diagram. This allows you to control the tooltip visibility programmatically rather than relying on user hover actions. In some cases, you may want to display the tooltip without requiring the user to hover over the object.
...
To display tooltips on mouseover, set the desired tooltip text to the [`tooltip`](https://ej2.syncfusion.com/javascript/documentation/api/diagram#tooltip) property of the annotation.
Tooltips for Annotations can be enabled or disabled by setting the [`AnnotationConstraints`](https://ej2.syncfusion.com/javascript/documentation/api/diagram/annotationConstraints) property as `Tooltip`. 
