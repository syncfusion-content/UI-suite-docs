...
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-2/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-3/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-4/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/umlsequencediagram-4/index.html %}
{% endhighlight %}
