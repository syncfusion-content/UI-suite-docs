...
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs2/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs5/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs5/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs3/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs4/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs4/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs6/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/diagram-sdk/typescript/pagesettings-cs6/index.html %}
{% endhighlight %}
