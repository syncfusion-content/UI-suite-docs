...
To create a text node, set the shape property to [`text`](https://ej2.syncfusion.com/angular/documentation/api/diagram/textmodel) and define the content object with your desired text and styling options.
...
To create an image node, set the shape property to [`image`](https://ej2.syncfusion.com/angular/documentation/api/diagram/imagemodel) and specify the image source through the source property.
...
Set the shape property to [`HTML`](https://ej2.syncfusion.com/angular/documentation/api/diagram/htmlmodel) to create HTML nodes. You can define content using either inline templates or external node templates.
...
To create a [`native`](https://ej2.syncfusion.com/angular/documentation/api/diagram/nativemodel) node, set the shape property to **native** and provide SVG content through the content property.
...
To create a [`path`](https://ej2.syncfusion.com/angular/documentation/api/diagram/pathmodel) node, set the shape property to **path** and define the geometry through the [`data`](https://ej2.syncfusion.com/angular/documentation/api/diagram/pathModel#data) property using standard SVG path syntax.
...
To create [`flow`](https://ej2.syncfusion.com/angular/documentation/api/diagram/flowshapemodel) shapes, set the shape type to **flow** and specify the desired flow shape variant. The default flow shape is **process**.
