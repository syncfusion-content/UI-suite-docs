...
* The [`header`](https://ej2.syncfusion.com/vue/documentation/api/diagram/lanemodel#header) property of lane allows you to textually describe the lane and to customize the appearance of the description.
...
* The appearance of lane can be set by using the [`style`](https://ej2.syncfusion.com/vue/documentation/api/diagram/lanemodel#style) properties.
