...
description: Check out and learn about getting started with ASP.NET MVC Rich Text Editor control of Syncfusion Essential JS 2 and more details.
...
Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET MVC Rich Text Editor control to the `~/Views/Home/Index.cshtml` page.
