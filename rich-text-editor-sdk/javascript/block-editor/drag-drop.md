...
You can control the drag and drop functionality within the Block Editor using the [enableDragAndDrop](https://ej2.syncfusion.com/javascript/documentation/api/blockeditor/index-default#enabledraganddrop) property. This feature is enabled by default (`true`).
