---
layout: post
title: Content Security Policy in JavaScript Rich text editor | Syncfusion
description: Learn here all about Content Security Policy in Syncfusion JavaScript Rich text editor control of Syncfusion Essential JS 2 and more.
...
# Content Security Policy (CSP) in JavaScript Rich Text Editor
...
The following example shows a recommended CSP configuration for a JavaScript application that hosts the Syncfusion Rich Text Editor:
...
| `script-src` | `'self'` | Allows scripts from the same origin, sufficient for the editor's JavaScript runtime. |
