---
layout: post
title: Mail Merge in JavaScript Rich Text Editor Control | Syncfusion
description: Learn all about Mail Merge in the Syncfusion JavaScript Rich Text Editor control, part of Essential JS 2.
