---
layout: post
title: Spell & Grammar Check in JavaScript Richtexteditor | Syncfusion
description: Learn here all about Spell & Grammar Check in Syncfusion JavaScript Rich text editor control of Syncfusion Essential JS 2 and more.
...
# Integrate WProofreader into the JavaScript Rich Text Editor control
...
{% include code-snippet/rich-text-editor-sdk/javascript/rich-text-editor/javascript/rich-text-editor/spell-check-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor-sdk/javascript/rich-text-editor/javascript/rich-text-editor/spell-check-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor-sdk/javascript/rich-text-editor/javascript/rich-text-editor/spell-check-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/rich-text-editor-sdk/javascript/rich-text-editor/javascript/rich-text-editor/spell-check-cs1/index.html %}
{% endhighlight %}
