...
By default, a tooltip is displayed when the user hovers over an action item. You can show or hide the tooltip using the [enableTooltip](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockactionmenusettingsmodel#enabletooltip) property in the block action menu settings.
...
|Name|Args|Description|
|---|---|---|
|[itemSelect](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/transformsettingsmodel#itemselect)|TransformItemSelectEventArgs|Triggers when a command item is clicked.|
