...
You can configure blocks with various properties such as [id](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#id), [blockType](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#blocktype), [content](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#content) to create a rich and structured editor.
...
You can specify the indentation level of a block using the [indent](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#indent) property. This property accepts a numeric value that determines how deeply a block is nested from the left margin.

By default, the [indent](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#indent) property is set to `0`.
...
You can apply custom styling to individual blocks using the [cssClass](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#cssclass) property. This property accepts a string containing one or more CSS class names.
...
The Block Editor allows you to use custom templates for specialized content using the [template](https://ej2.syncfusion.com/vue/documentation/api/blockeditor/blockmodel#template) property. Templates can be defined as strings, functions, or HTML elements.
