---
layout: post
title: Custom Toolbar in ASP.NET Core Rich Text Editor Control | Syncfusion
description: Learn here all about Custom Toolbar in Syncfusion ASP.NET Core Rich Text Editor control of Syncfusion Essential JS 2 and more.
