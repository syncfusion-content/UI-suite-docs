---
layout: post
title: Read-only Mode in ASP.NET Core Rich Text Editor Control
description: Learn here all about Read-only Mode in Syncfusion ASP.NET Core Rich Text Editor control of Syncfusion Essential JS 2 and more.
...
# Read-only Mode in the ASP.NET Core Rich Text Editor Control
