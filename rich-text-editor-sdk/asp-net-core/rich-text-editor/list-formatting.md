---
layout: post
title: List formatting in ASP.NET Core Rich Text Editor Control
description: Learn here all about List formatting in Syncfusion ASP.NET Core Rich Text Editor control of Syncfusion Essential JS 2 and more.
...
# List Formatting in ASP.NET Core Rich Text Editor Control
