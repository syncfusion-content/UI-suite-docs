---
layout: post
title: Audios in ASP.NET Core Rich Text Editor Control | Syncfusion
description: Learn here all about Audios in Syncfusion ASP.NET Core Rich Text Editor control of Syncfusion Essential JS 2 and more.
...
# Audios in ASP.NET Core Rich text editor Control
