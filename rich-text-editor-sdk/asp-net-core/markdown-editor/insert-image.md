...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-image/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-image/controller.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-image/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-image/controller.cs %}
{% endhighlight %}
