---
layout: post
title: Customizing Markdown Syntax in ASP.NET Core Markdown Editor Control | Syncfusion
description: Checkout and learn about Customizing Markdown Syntax in ASP.NET Core Markdown Editor control of Syncfusion Essential JS 2 and more details.
...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-custom-format/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-custom-format/controller.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-custom-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Controller.cs" %}
{% include code-snippet/rich-text-editor-sdk/asp-net-core/markdown-editor/asp-net-core/markdown-editor/markdown-custom-format/controller.cs %}
{% endhighlight %}
