---
layout: post
title: Flat data in JavaScript File Manager component | Syncfusion
description: Learn how to render flat data using the JavaScript File Manager component and how to integrate cloud services (Google Drive) via action events.
...
# Rendering flat JSON data in the JavaScript File Manager component
