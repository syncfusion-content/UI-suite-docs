---
layout: post
title: Render ASP.NET MVC File Manager in Internet Explorer | Syncfusion
description: Learn here all about Render File Manager In Internet Explorer in ASP.NET MVC File Manager control of syncfusion and more.
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/filemanager-in-ie/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_core.cshtml" %}
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/filemanager-in-ie/HomeController_core.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/filemanager-in-ie/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Layout_mvc.cshtml" %}
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/filemanager-in-ie/Layout_mvc.cshtml %}
{% endhighlight %}
{% endtabs %}
{% endif %}
