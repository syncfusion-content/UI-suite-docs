---
layout: post
title: Add Custom Toolbar Items in ASP.NET MVC File Manager | Syncfusion
description: Learn here all about Adding Custom Item To Toolbar in ASP.NET MVC File Manager control of Syncfusion Essential JS 2 and more.
