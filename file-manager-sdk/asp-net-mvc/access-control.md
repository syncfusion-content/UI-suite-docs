---
layout: post
title: Access Control in Syncfusion ASP.NET MVC File Manager | Syncfusion
description: Learn here all about Access Control in ASP.NET MVC File Manager control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/access-control/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-mvc/asp-net-mvc/access-control/razor %}
{% endhighlight %}
{% endtabs %}
{% endif %}
