---
layout: post
title: Drag And Drop in ASP.NET Core File Manager Control | Syncfusion
description: Learn here all about Drag And Drop in ASP.NET Core File Manager control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/drag-and-drop/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_core.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/drag-and-drop/HomeController_core.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/drag-and-drop/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_mvc.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/drag-and-drop/HomeController_mvc.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
