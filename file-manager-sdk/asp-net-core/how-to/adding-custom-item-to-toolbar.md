---
layout: post
title: Add Custom Toolbar Items in ASP.NET Core File Manager | Syncfusion
description: Learn here all about Adding Custom Item To Toolbar in ASP.NET Core File Manager control of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/how-to/toolbar/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_core.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/how-to/toolbar/HomeController_core.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/how-to/toolbar/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController_mvc.cs" %}
{% include code-snippet/file-manager-sdk/asp-net-core/asp-net-core/how-to/toolbar/HomeController_mvc.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
