---
layout: post
title: Enable Virtualization in ASP.NET Core File Manager | Syncfusion
description: Learn here all about Virtualization in ASP.NET Core File Manager control of Syncfusion Essential JS 2 and more.
