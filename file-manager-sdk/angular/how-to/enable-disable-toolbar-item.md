...
description: Learn here all about Enable disable toolbar item in Angular File Manager component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/file-manager-sdk/angular/angular/toolbar-items-cs1/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="styles.css" %}
{% include code-snippet/file-manager-sdk/angular/angular/toolbar-items-cs1/src/styles.css %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/file-manager-sdk/angular/angular/toolbar-items-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/file-manager-sdk/angular/help.syncfusion.com/samples/file-manager-sdk/angular/toolbar-items-cs1" %}
