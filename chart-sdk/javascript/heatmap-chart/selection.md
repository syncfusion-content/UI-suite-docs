...
{% include code-snippet/chart-sdk/javascript/heatmap-chart/selection-cs1/index.ts %}
{% endhighlight %}
...
{% if page.publishingplatform == "typescript" %}
 ...
 {% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/chart-sdk/javascript/heatmap-chart/selection-cs2/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/chart-sdk/javascript/heatmap-chart/selection-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
