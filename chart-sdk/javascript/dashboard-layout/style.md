---
layout: post
title: Style in JavaScript Dashboard Layout control | Syncfusion
description: Learn here all about Style in Syncfusion JavaScript Dashboard Layout control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Style 
