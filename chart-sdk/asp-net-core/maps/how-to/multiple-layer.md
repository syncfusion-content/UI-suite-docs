...
{% include code-snippet/chart-sdk/asp-net-core/maps/multilayer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Multilayer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/multilayer/multilayer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/maps/multilayer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multilayer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/multilayer/multilayer.cs %}
{% endhighlight %}
