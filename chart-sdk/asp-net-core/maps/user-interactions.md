---
layout: post
title: User Interactions in Syncfusion ASP.NET Core Maps Component
description: Learn here all about User Interactions in Syncfusion ASP.NET Core Maps component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
# User Interactions in ASP.NET Core Maps Component
...
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/panning/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Panning.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/panning/panning.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/panning/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Panning.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/panning/panning.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Zoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom/zoom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Zoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom/zoom.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/pinchzoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Pinchzoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/pinchzoom/pinchzoom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/pinchzoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Pinchzoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/pinchzoom/pinchzoom.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/singleclickzoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Singleclick.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/singleclickzoom/singleclick.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/singleclickzoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Singleclick.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/singleclickzoom/singleclick.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/doubleclickzoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Doubleclick.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/doubleclickzoom/doubleclick.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/doubleclickzoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Doubleclick.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/doubleclickzoom/doubleclick.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/mousewheel/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Mousewheel.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/mousewheel/mousewheel.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/mousewheel/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Mousewheel.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/mousewheel/mousewheel.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selectionzooming/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Selectionzooming.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selectionzooming/selectionzooming.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selectionzooming/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Selectionzooming.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selectionzooming/selectionzooming.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/minzooming/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Minzooming.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/minzooming/minzooming.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/minzooming/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Minzooming.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/minzooming/minzooming.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/animationzoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Animationzoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/animationzoom/animationzoom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/animationzoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Animationzoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/animationzoom/animationzoom.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ZoomToolbar.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar/zoom-toolbar.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ZoomToolbar.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar/zoom-toolbar.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar-button/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="zoomToolbarButton.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar-button/zoom-toolbar-button.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar-button/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ZoomToolbarButton.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/zoom-toolbar-button/zoom-toolbar-button.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/toolbar-button-tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="ToolbarButtonTooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/toolbar-button-tooltip/toolbar-button-tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/toolbar-button-tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="ToolbarButtonTooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/toolbar-button-tooltip/toolbar-button-tooltip.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Selection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection/selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Selection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection/selection.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-bubble/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-bubble.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-bubble/selection-bubble.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-bubble/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-bubble.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-bubble/selection-bubble.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-marker/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-marker.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-marker/selection-marker.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-marker/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-marker.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-marker/selection-marker.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-selection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Polygon-shape-selection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-selection/polygon-shape-selection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-selection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Polygon-shape-selection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-selection/polygon-shape-selection.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-method/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-method.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-method/selection-method.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-method/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Selection-method.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/selection-method/selection-method.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initial-shape/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Initial-shape.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initial-shape/initial-shape.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initial-shape/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Initial-shape.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initial-shape/initial-shape.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initialmarkerselection/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Initialmarkerselection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initialmarkerselection/initialmarkerselection.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initialmarkerselection/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Initialmarkerselection.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/initialmarkerselection/initialmarkerselection.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight/highlight.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight/highlight.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-bubble/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight-bubble.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-bubble/highlight-bubble.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-bubble/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight-bubble.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-bubble/highlight-bubble.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-marker/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight-marker.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-marker/highlight-marker.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-marker/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Highlight-marker.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/highlight-marker/highlight-marker.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-highlight/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Polygon-shape-highlight.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-highlight/polygon-shape-highlight.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-highlight/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Polygon-shape-highlight.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/polygon/polygon-shape-highlight/polygon-shape-highlight.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip/tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip/tooltip.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-customization/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-customization/tooltip-customization.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-customization/tooltip-customization.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-template.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-template/tooltip-template.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-template/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-template.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-template/tooltip-template.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-duration/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-duration.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-duration/tooltip-duration.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-duration/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-duration.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/maps/user-interactions/tooltip-duration/tooltip-duration.cs %}
{% endhighlight %}
