---
layout: post
title: Getting started with ASP.NET Core Sankey Chart Component
description: Checkout and learn about Getting started with ASP.NET Core Sankey Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
## Add ASP.NET Core Sankey Chart control

Now, add the Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Sankey Chart tag helper in `~/Pages/Index.cshtml` page.

{% if page.publishingplatform == "aspnet-core" %}

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/initialize/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Initialize.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/initialize/initialize.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/initialize/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Initialize.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/initialize/initialize.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/data/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/data/data.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/data/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Data.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/getting-started/data/data.cs %}
{% endhighlight %}
