---
layout: post
title: Legend in Syncfusion ASP.NET Core Sankey Chart Component
description: Learn here all about Legend in Syncfusion ASP.NET Core Sankey Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Legend
...
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/basic-legend/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Basic-legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/basic-legend/basic-legend.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/basic-legend/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Basic-legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/basic-legend/basic-legend.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/legend-position/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Legend-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/legend-position/legend-position.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/legend-position/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Legend-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/legend-position/legend-position.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/customized-legend/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Customized-legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/customized-legend/customized-legend.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/customized-legend/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Customized-legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/customized-legend/customized-legend.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/custom-legend-position/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Custom-legend-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/custom-legend-position/custom-legend-position.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/custom-legend-position/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Custom-legend-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/custom-legend-position/custom-legend-position.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/dynamic-legend-custom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamic-legend-custom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/dynamic-legend-custom/dynamic-legend-custom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/dynamic-legend-custom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamic-legend-custom.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/legend/dynamic-legend-custom/dynamic-legend-custom.cs %}
{% endhighlight %}
