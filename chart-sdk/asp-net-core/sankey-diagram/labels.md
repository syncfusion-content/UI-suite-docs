---
layout: post
title: Labels in ASP.NET Core Sankey Chart Component
description: Learn here all about Labels in Syncfusion ASP.NET Core Sankey Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Labels
...
# Labels in ASP.NET Core Sankey Chart component
...
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/label-configuration/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Label-configuration.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/label-configuration/label-configuration.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/label-configuration/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-configuration.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/label-configuration/label-configuration.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/hiding-labels/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Hiding-labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/hiding-labels/hiding-labels.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/hiding-labels/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Hiding-labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/hiding-labels/hiding-labels.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/font-style/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Font-style.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/font-style/font-style.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/font-style/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Font-style.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/font-style/font-style.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/individual-node-labels/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Individual-node-labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/individual-node-labels/individual-node-labels.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/individual-node-labels/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Individual-node-labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/individual-node-labels/individual-node-labels.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/dynamic-label/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamic-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/dynamic-label/dynamic-label.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/dynamic-label/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamic-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/labels/dynamic-label/dynamic-label.cs %}
{% endhighlight %}
