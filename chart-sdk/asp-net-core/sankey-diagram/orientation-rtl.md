---
layout: post
title: Orientation and RTL in ASP.NET Core Sankey Chart Component
description: Learn here all about Orientation and RTL in Syncfusion ASP.NET Core Sankey Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
# Orientation and RTL in ASP.NET Core Sankey Chart component
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/orientation/vertical-orientation/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/orientation/rtl/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sankey-diagram/orientation/rtl-horizontal/tagHelper %}
{% endhighlight %}
