...
description: Checkout and learn about getting started with ASP.NET Core Accumulation Chart control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-core/accumulation-chart/accumulation-charts/datalabel/initial/tagHelper %}
{% endhighlight %}
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> ASP.NET Core Accumulation Chart control will be rendered in the default web browser.
