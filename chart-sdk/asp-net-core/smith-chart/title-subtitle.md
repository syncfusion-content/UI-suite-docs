...
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/title/title/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Title.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/title/title/title.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/title/title-trim/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Title-trim.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/title/title-trim/title-trim.cs %}
{% endhighlight %}
