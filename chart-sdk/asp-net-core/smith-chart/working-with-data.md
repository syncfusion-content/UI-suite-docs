---
layout: post
title: Working With Data in ASP.NET Core Smithchart Component
description: Learn here all about Working With Data in Syncfusion ASP.NET Core Smithchart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/data/working-with-data/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Working-with-data.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/smith-chart/data/working-with-data/working-with-data.cs %}
{% endhighlight %}
