---
layout: post
title: Ajax Chart Call in ASP.NET Core Chart Component
...
{% include code-snippet/chart-sdk/asp-net-core/charts/how-to/ajax-data/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Ajax-data.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/charts/how-to/ajax-data/ajax-data.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/charts/how-to/ajax-data/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Ajax-data.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/charts/how-to/ajax-data/ajax-data.cs %}
{% endhighlight %}
