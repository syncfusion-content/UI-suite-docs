---
layout: post
title: Floating Panel in ASP.NET Core Dashboard Layout control
description: Learn here all about Floating Panel in Syncfusion ASP.NET Core Dashboard Layout control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
