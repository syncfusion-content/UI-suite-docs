---
layout: post
title: Dimensions in ASP.NET Core 3D Chart Component
description: Learn here all about dimensions in Syncfusion ASP.NET Core 3D Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Dimensions
...
# Dimensions in ASP.NET Core 3D Chart Component
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/3d-charts/series/appearance/percentage/tagHelper %}
{% endhighlight %}
