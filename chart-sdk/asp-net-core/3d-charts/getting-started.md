---
layout: post
title: Getting Started with ASP.NET Core 3D Chart Control | Syncfusion
description: Checkout and learn about getting started with ASP.NET Core 3D Chart control of Syncfusion Essential JS 2 and more details.
platform: chart-sdk
...
This section briefly explains about how to include [ASP.NET Core 3D Chart](https://www.syncfusion.com/aspnet-core-ui-controls/charts) control in your ASP.NET Core application using Visual Studio.
