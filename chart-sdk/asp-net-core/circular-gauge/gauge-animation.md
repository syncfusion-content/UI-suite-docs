---
layout: post
title: Animation in ASP.NET Core Circular Gauge component | Syncfusion
description: Learn here all about animation in the Syncfusion ASP.NET Core Circular Gauge component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-animation/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-animation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Animation.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-animation/gauge-animation.cs %}
{% endhighlight %}
{% endtabs %}
