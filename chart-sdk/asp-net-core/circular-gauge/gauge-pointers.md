...
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/pointers/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Pointers.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/pointers/pointers.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/needle-pointers/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Needle-pointers.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/needle-pointers/needle-pointers.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/customization/customization.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/needle-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Needle-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/needle-customization/needle-customization.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/rangebar-pointer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Rangebar-pointer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/rangebar-pointer/rangebar-pointer.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/pointer-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Pointer-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/pointer-customization/pointer-customization.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/rangebarroundedcorner/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Rangebar-pointer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/rangebarroundedcorner/rangebar-pointer.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/marker-pointer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Marker-pointer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/marker-pointer/marker-pointer.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/marker-customization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Marker-customization.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/marker-customization/marker-customization.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/dragging-pointer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dragging-pointer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/dragging-pointer/dragging-pointer.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/gauge-pointers-drag/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Pointer-drag.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/gauge-pointers-drag/gauge-pointers-drag.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/multiple-pointer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multiple-pointer.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/multiple-pointer/multiple-pointer.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/animation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Animation.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/animation/animation.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/lineargradient/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Lineargradient.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/lineargradient/lineargradient.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/radialgradient/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Radialgradient.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-pointers/radialgradient/radialgradient.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
