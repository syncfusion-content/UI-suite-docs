...
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/axes/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Axes.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/axes/axes.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/angles/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Angles.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/angles/angles.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/direction/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Direction.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/direction/direction.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/radius-pixel/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Radius-pixel.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/radius-pixel/radius-pixel.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/radius-percentage/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Radius-percentage.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/radius-percentage/radius-percentage.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/ticks/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Ticks.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/ticks/ticks.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/tick-position/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tick-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/tick-position/tick-position.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/labels/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/labels/labels.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/label-position/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-position.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/label-position/label-position.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/auto-angles/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Auto-angles.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/auto-angles/auto-angles.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/smart-labels/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Smart-labels.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/smart-labels/smart-labels.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/label-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-format.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/label-format/label-format.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/custom-label-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Custom-label-format.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/custom-label-format/custom-label-format.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/hide-intersecting-label/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Hide-intersecting-label.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/hide-intersecting-label/hide-intersecting-label.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/minMax/razor %}
{% endhighlight %}
{% highlight c# tabtitle="MinMax.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/minMax/minMax.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/multiple-axes/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multiple-axes.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/circular-gauge/gauge-axes/multiple-axes/multiple-axes.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
