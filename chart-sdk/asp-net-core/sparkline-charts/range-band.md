...
{% include code-snippet/chart-sdk/asp-net-core/sparkline-charts/rangeband/range/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Range.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sparkline-charts/rangeband/range/range.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/sparkline-charts/rangeband/multi-range/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Multi_range.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/sparkline-charts/rangeband/multi-range/multi-range.cs %}
{% endhighlight %}
