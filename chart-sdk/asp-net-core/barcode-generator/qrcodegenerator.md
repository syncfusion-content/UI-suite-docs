---
layout: post
title: Qrcodegenerator in ASP.NET Core Barcode Control | Syncfusion
description: Learn here all about Qrcodegenerator in Syncfusion ASP.NET Core Barcode control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/qrcode/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/qrcode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Qrcode.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/qrcode/qrcode.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/color/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/color/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Color.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/color/color.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/dimension/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/dimension/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Dimension.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/dimension/dimension.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/logo/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/logo/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Logo.cs" %}
{% include code-snippet/chart-sdk/asp-net-core/barcode-generator/qrcode/logo/logo.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
