...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/circular-gauge/getting-started-cs64/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/circular-gauge/getting-started-cs64" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/app.vue" %}
{% include code-snippet/chart-sdk/vue/circular-gauge/getting-started-cs65/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/circular-gauge/getting-started-cs65" %}
