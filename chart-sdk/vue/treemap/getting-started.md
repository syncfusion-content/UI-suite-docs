...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs60/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs60/app.vue %}
{% endhighlight %}
{% endtabs %}
...
yarn run serve
```
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/treemap/getting-started-cs60" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs15/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs15/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/treemap/getting-started-cs15" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs16/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs16/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/treemap/getting-started-cs16" %}
...
{% tabs %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs17/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="~/src/App.vue" %}
{% include code-snippet/chart-sdk/vue/treemap/getting-started-cs17/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/vue/treemap/getting-started-cs17" %}
