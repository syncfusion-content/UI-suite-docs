---
layout: post
title: Getting Started with ASP.NET MVC Stock Chart Control | Syncfusion
...
{% include code-snippet/chart-sdk/asp-net-mvc/stock-chart/getting-started/populateData/razor %}
{% endhighlight %}
{% highlight cshtml tabtitle="financial-data.js" %}
{% include code-snippet/chart-sdk/asp-net-mvc/stock-chart/financial-data.js %}
{% endhighlight %}
{% endtabs %}
