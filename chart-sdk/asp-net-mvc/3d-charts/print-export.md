...
{% include code-snippet/chart-sdk/asp-net-mvc/3d-charts/series/user-interaction/print/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/3d-charts/series/user-interaction/export/tagHelper %}
{% endhighlight %}
