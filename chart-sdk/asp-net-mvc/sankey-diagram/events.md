...
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/load-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Load-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/load-event/load-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/load-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Load-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/load-event/load-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/loaded-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Loaded-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/loaded-event/loaded-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/loaded-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Loaded-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/loaded-event/loaded-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-interaction-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Node-interaction-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-interaction-event/node-interaction-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-interaction-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Node-interaction-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-interaction-event/node-interaction-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-interaction-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Link-interaction-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-interaction-event/link-interaction-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-interaction-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Link-interaction-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-interaction-event/link-interaction-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-rendering-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Node-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-rendering-event/node-rendering-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-rendering-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Node-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/node-rendering-event/node-rendering-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-rendering-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Link-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-rendering-event/link-rendering-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-rendering-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Link-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/link-rendering-event/link-rendering-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/label-rendering-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Label-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/label-rendering-event/label-rendering-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/label-rendering-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/label-rendering-event/label-rendering-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/legend-item-rendering-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Legend-item-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/legend-item-rendering-event/legend-item-rendering-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/legend-item-rendering-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Legend-item-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/legend-item-rendering-event/legend-item-rendering-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/size-changed-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Size-changed-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/size-changed-event/size-changed-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/size-changed-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Size-changed-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/size-changed-event/size-changed-event.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/complete-event-handler/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Complete-event-handler.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/complete-event-handler/complete-event-handler.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/complete-event-handler/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Complete-event-handler.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/events/complete-event-handler/complete-event-handler.cs %}
{% endhighlight %}
