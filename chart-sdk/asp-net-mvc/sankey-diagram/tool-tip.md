...
This guide outlines how to enable and customize tooltips in the ASP.NET MVC Sankey Chart.
...
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/basic-tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Basic-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/basic-tooltip/basic-tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/basic-tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Basic-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/basic-tooltip/basic-tooltip.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/customized-tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Customized-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/customized-tooltip/customized-tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/customized-tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Customized-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/customized-tooltip/customized-tooltip.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/link-tooltip/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Link-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/link-tooltip/link-tooltip.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/link-tooltip/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Link-tooltip.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/link-tooltip/link-tooltip.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/inline-format/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Inline-format.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/inline-format/inline-format.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/inline-format/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Inline-format.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/inline-format/inline-format.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/tooltip-rendering-event/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/tooltip-rendering-event/tooltip-rendering-event.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/tooltip-rendering-event/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Tooltip-rendering-event.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/sankey-diagram/tooltip/tooltip-rendering-event/tooltip-rendering-event.cs %}
{% endhighlight %}
