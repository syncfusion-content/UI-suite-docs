...
{% include code-snippet/chart-sdk/asp-net-mvc/linear-gauge/methods/setPointerValue/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/linear-gauge/methods/setAnnotationValue/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/linear-gauge/methods/refresh/tagHelper %}
{% endhighlight %}
{% endtabs %}
