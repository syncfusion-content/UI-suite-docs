---
layout: post
title: Bing Maps in Syncfusion ASP.NET MVC Syncfusion Maps Component
...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bing/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Bing.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bing/bing.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingzoom/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="BingZoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingzoom/bingzoom.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingzoom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="BingZoom.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingzoom/bingzoom.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingmarker/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="BingMarker.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingmarker/bingmarker.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingmarker/razor %}
{% endhighlight %}
{% highlight c# tabtitle="BingMarker.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/bingmarker/bingmarker.cs %}
{% endhighlight %}
...
Any GeoJSON shape can be rendered as a sublayer on top of the Bing Maps layer for highlighting a particular continent or country in Bing Maps by adding another layer and specifying the [Type](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Maps.MapsLayer.html#Syncfusion_EJ2_Maps_MapsLayer_Type) property of Maps layer to **SubLayer**.

{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/bing/bingsublayer/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="BingSubLayer.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/bing/bingsublayer/bingsublayer.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/bing/bingsublayer/razor %}
{% endhighlight %}
{% highlight c# tabtitle="BingSubLayer.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/bing/bingsublayer/bingsublayer.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/binglegend/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="BingLegend.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/binglegend/binglegend.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/binglegend/razor %}
{% endhighlight %}
{% highlight c# tabtitle="BingLegend.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/map-providers/binglegend/binglegend.cs %}
{% endhighlight %}
