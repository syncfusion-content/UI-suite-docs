...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/custom-path/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Custom-path.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/custom-path/custom-path.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/custom-path/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Custom-path.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/custom-path/custom-path.cs %}
{% endhighlight %}
