...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/Internationalization/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Internationalization.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/Internationalization/internationalization.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/Internationalization/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Internationalization.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/Internationalization/internationalization.cs %}
{% endhighlight %}
