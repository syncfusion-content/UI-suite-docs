...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/polygon/polygon-shape/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/polygon/polygon-shape-tooltip/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/polygon/polygon-shape-tooltip-template/tagHelper %}
{% endhighlight %}
