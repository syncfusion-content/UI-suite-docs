...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/colorvaluepath/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Colorvaluepath.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/colorvaluepath/colorvaluepath.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/colorvaluepath/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Colorvaluepath.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/colorvaluepath/colorvaluepath.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/equalcolormapping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Equalcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/equalcolormapping/equalcolormapping.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/equalcolormapping/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Equalcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/equalcolormapping/equalcolormapping.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationcolormapping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Desaturationcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationcolormapping/desaturationcolormapping.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationcolormapping/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Desaturationcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationcolormapping/desaturationcolormapping.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationwithmultiplecolors/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Desaturationwithmultiplecolors.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationwithmultiplecolors/desaturationwithmultiplecolors.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationwithmultiplecolors/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Desaturationwithmultiplecolors.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/desaturationwithmultiplecolors/desaturationwithmultiplecolors.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/excludedcolormapping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Excludedcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/excludedcolormapping/excludedcolormapping.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/excludedcolormapping/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Excludedcolormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/excludedcolormapping/excludedcolormapping.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/bubble-colormapping/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Bubble-colormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/bubble-colormapping/bubble-colormapping.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/bubble-colormapping/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Bubble-colormapping.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/colormapping/bubble-colormapping/bubble-colormapping.cs %}
{% endhighlight %}
