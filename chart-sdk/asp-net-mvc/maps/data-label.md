---
layout: post
title: Data Label in Syncfusion ASP.NET MVC Maps Component
description: Learn here all about Data Label in Syncfusion ASP.NET MVC Maps component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Data Label
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/datalabel/label-ds/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-ds.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/datalabel/label-ds/label-ds.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/datalabel/label-animation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Label-animation.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/maps/datalabel/label-animation/label-animation.cs %}
{% endhighlight %}
