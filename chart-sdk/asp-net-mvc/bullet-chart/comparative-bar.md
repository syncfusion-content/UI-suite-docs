...
{% include code-snippet/chart-sdk/asp-net-mvc/bullet-chart/target-bar/target-bar/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/bullet-chart/target-bar/target-types/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/bullet-chart/target-bar/target-color/tagHelper %}
{% endhighlight %}
