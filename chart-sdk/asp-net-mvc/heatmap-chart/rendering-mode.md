---
layout: post
title: Rendering Mode in Syncfusion ASP.NET MVC Heatmap Chart Component
description: Learn here all about Rendering Mode in Syncfusion ASP.NET MVC Heatmap Chart component of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
# Rendering mode in ASP.NET MVC HeatMap Chart Component
...
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/rendering-mode/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Rendering-mode.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/rendering-mode/rendering-mode.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/rendering-mode/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Rendering-mode.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/rendering-mode/rendering-mode.cs %}
{% endhighlight %}
