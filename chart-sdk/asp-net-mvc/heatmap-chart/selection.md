...
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/selection/cellSelection/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/selection/singleCellSelection/tagHelper %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/heatmap-chart/selection/clear-selection/tagHelper %}
{% endhighlight %}
