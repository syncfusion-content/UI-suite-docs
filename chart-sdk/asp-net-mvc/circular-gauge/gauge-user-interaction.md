---
layout: post
title: Gauge User Interaction in ASP.NET MVC Circular Gauge Control | Syncfusion
description: Learn here all about Gauge User Interaction in Syncfusion ASP.NET MVC Circular Gauge control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-user-interaction/template/razor %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-user-interaction/pointer-drag/razor %}
{% endhighlight %}
