---
layout: post
title: Animation in ASP.NET MVC Circular Gauge component | Syncfusion
...
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-animation/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-animation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Animation.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-animation/gauge-animation.cs %}
{% endhighlight %}
{% endtabs %}
