---
layout: post
title: Gauge Legend in ASP.NET MVC Circular Gauge Control | Syncfusion
description: Learn here all about Gauge Legend in Syncfusion ASP.NET MVC Circular Gauge control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend/legend.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/toggle-legend/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/toggle-legend/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Toggle-legend.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/toggle-legend/toggle-legend.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/paging-support/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/paging-support/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Paging-support.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/paging-support/paging-support.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend-text-custom/tagHelper %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend-text-custom/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Legend-text-custom.cs" %}
{% include code-snippet/chart-sdk/asp-net-mvc/circular-gauge/gauge-legend/legend-text-custom/legend-text-custom.cs %}
{% endhighlight %}
{% endtabs %}
{% endif %}
