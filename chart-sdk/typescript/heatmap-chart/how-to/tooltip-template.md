---
layout: post
title: Tooltip template in TypeScript Heatmap chart control | Syncfusion
description: Learn here all about Tooltip template in Syncfusion TypeScript Heatmap chart control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
