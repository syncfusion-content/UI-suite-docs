---
layout: post
title: Internationalization in TypeScript Linear gauge control | Syncfusion
description: Learn here all about Internationalization in Syncfusion TypeScript Linear gauge control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
# Internationalization in TypeScript Linear gauge control
...
{% include code-snippet/chart-sdk/typescript/linear-gauge/getting-started-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/linear-gauge/getting-started-cs1/index.html %}
{% endhighlight %}
