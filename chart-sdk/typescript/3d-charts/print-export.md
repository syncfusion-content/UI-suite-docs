---
layout: post
title: Print and Export in TypeScript 3D Chart control | Syncfusion
description: Learn here all about print and export in Syncfusion TypeScript 3D Chart control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: 3D Chart 
...
# Print and Export in TypeScript 3D Chart control
...
{% include code-snippet/chart-sdk/typescript/3d-charts/print-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/3d-charts/print-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/chart-sdk/typescript/3d-charts/print-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/3d-charts/print-cs2/index.html %}
{% endhighlight %}
