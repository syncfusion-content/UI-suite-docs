---
layout: post
title: Cross hair in TypeScript Stock chart control | Syncfusion
description: Learn here all about Cross hair in Syncfusion TypeScript Stock chart control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Cross hair 
...
# Cross hair in TypeScript Stock chart control
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/chart-sdk/typescript/stock-chart/getting-started-cs13/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/chart-sdk/typescript/stock-chart/getting-started-cs14/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/chart-sdk/typescript/stock-chart/getting-started-cs39/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
