...
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs16/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs16/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.js" %}
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs17/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs17/index.html %}
{% endhighlight %}
...
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs497/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/accumulation-chart/chart-types-cs497/index.html %}
{% endhighlight %}
