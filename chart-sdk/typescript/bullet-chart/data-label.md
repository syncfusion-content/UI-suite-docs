---
layout: post
title: Data label in TypeScript Bullet chart control | Syncfusion
description: Learn here all about Data label in Syncfusion TypeScript Bullet chart control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Data label 
...
# Data label in TypeScript Bullet chart control
...
{% include code-snippet/chart-sdk/typescript/bullet-chart/datalabel-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/bullet-chart/datalabel-cs1/index.html %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/chart-sdk/typescript/bullet-chart/datalabel-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/bullet-chart/datalabel-cs2/index.html %}
{% endhighlight %}
