---
layout: post
title: Ranges in TypeScript Bullet chart control | Syncfusion
description: Learn here all about Ranges in Syncfusion TypeScript Bullet chart control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
control: Ranges 
...
# Ranges in TypeScript Bullet chart control
...
{% include code-snippet/chart-sdk/typescript/bullet-chart/ranges-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/bullet-chart/ranges-cs2/index.html %}
{% endhighlight %}
