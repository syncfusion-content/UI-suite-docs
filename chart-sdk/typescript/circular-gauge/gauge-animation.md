---
layout: post
title: Animation in TypeScript Circular Gauge control | Syncfusion
description: Learn here all about animation in the Syncfusion TypeScript Circular Gauge control of Syncfusion Essential JS 2 and more.
platform: chart-sdk
...
# Animation in TypeScript Circular Gauge control
...
{% include code-snippet/chart-sdk/typescript/circular-gauge/gauge-animation-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/circular-gauge/gauge-animation-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/typescript/circular-gauge/gauge-animation-cs1" %}
...
{% include code-snippet/chart-sdk/typescript/circular-gauge/gauge-animation-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/chart-sdk/typescript/circular-gauge/gauge-animation-cs1/index.html %}
{% endhighlight %}
