...
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs89/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs89/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs89" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs90/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs90/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs90" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs105/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs105/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs105" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs106/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs106/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs106" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs107/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs107/app/index.tsx %}
{% endhighlight %}
{% endtabs %}
...
* [`border`](https://ej2.syncfusion.com/react/documentation/api/maps/selectionSettingsModel#border) - To customize the color, width, and opacity of the border of the element that is selected in Maps.
...
* [`enableMultiSelect`](https://ej2.syncfusion.com/react/documentation/api/maps/selectionSettingsModel#enablemultiselect) - To enable or disable the selection for multiple shapes, markers, or bubbles in the Maps.

By tapping on a specific legend, the shapes that are bound to the selected legend are also selected and vice versa.

{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs91/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs91/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs91" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs92/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs92/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs92" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs93/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs93/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs93" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/polygon-cs2/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/polygon-cs2/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/polygon-cs2" %}

### Public method for the shape selection

The [`shapeSelection`](https://ej2.syncfusion.com/react/documentation/api/maps#shapeselection) method can be used to select each shape in the Maps. The input parameters for this method are layer index, property name, property value (such as country name), and a boolean value (true/false) indicating the selection state.

{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs94/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs94/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs94" %}

### Initial shape selection

Shapes can be initially selected when the Maps loads using the [`initialShapeSelection`](https://ej2.syncfusion.com/react/documentation/api/maps/initialShapeSelectionSettingsModel) property. The values are mapped to the [`shapePath`](https://ej2.syncfusion.com/react/documentation/api/maps/initialShapeSelectionSettingsModel#shapepath) and [`shapeValue`](https://ej2.syncfusion.com/react/documentation/api/maps/initialShapeSelectionSettingsModel#shapevalue) properties.

>initialShapeSelection is an Array property.

{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs95/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs95/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs95" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs96/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs96/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs96" %}

## Highlight

Each shape in the Maps can be highlighted during mouse hover or touch interactions. This feature applies to Maps elements such as shapes, bubbles, markers, and legends. Highlight is enabled by setting the [`enable`](https://ej2.syncfusion.com/react/documentation/api/maps/highlightSettingsModel#enable) property of [`highlightSettings`](https://ej2.syncfusion.com/react/documentation/api/maps/highlightSettingsModel) to **true**.
...
* [`border`](https://ej2.syncfusion.com/react/documentation/api/maps/highlightSettingsModel#border) - To customize the color, width, and opacity of the border of the element that is highlighted in Maps.
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs97/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs97/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs97" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs98/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs98/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs98" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs99/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs99/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs99" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/polygon-cs3/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/polygon-cs3/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/polygon-cs3" %}

## Tooltip

On mouse over or touch end event, the tooltip is used to display additional information about the layer, bubble, or marker. To enable tooltips in Maps, the **Tooltip** module must be injected into Maps using the **Inject services={[Tooltip]}** tag. Tooltips can be enabled separately for layers or bubbles or markers by setting the [`visible`](https://ej2.syncfusion.com/react/documentation/api/maps/tooltipSettingsModel#visible) property of [`tooltipSettings`](https://ej2.syncfusion.com/react/documentation/api/maps/tooltipSettingsModel) to **true**. The [`valuePath`](https://ej2.syncfusion.com/react/documentation/api/maps/tooltipSettingsModel#valuepath) property specifies the field name from the data source whose value is displayed as the tooltip text. The [`tooltipDisplayMode`](https://ej2.syncfusion.com/react/documentation/api/maps/mapsModel#tooltipdisplaymode) property is used to change the display mode of the tooltip in Maps. The following display modes of tooltip are available in the Maps component. By default,  [`tooltipDisplayMode`](https://ej2.syncfusion.com/react/documentation/api/maps/mapsModel#tooltipdisplaymode) is set to **MouseMove**.
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs100/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs100/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs100" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs101/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs101/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs101" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs102/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs102/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs102" %}
...
{% tabs %}
{% highlight js tabtitle="index.jsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs110/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="index.tsx" %}
{% include code-snippet/chart-sdk/react/maps/code-path/default-map-cs110/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

 {% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/maps/default-map-cs110" %}
