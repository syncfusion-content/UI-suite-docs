...
{% tabs %}
{% highlight js tabtitle="App.jsx" %}
{% include code-snippet/chart-sdk/react/3d-circular-charts/code-path/getting-started/app/index.jsx %}
{% endhighlight %}
{% highlight ts tabtitle="App.tsx" %}
{% include code-snippet/chart-sdk/react/3d-circular-charts/code-path/getting-started/app/index.tsx %}
{% endhighlight %}
{% endtabs %}

{% previewsample "https://help.syncfusion.com/code-snippet/chart-sdk/react/3d-circular-charts/preview-sample/getting-started" %}
