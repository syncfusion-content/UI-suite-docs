...
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs26/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/chart-sdk/angular/bullet-chart/getting-started/range-cs26/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/chart-sdk/angular/bullet-chart/getting-started/range-cs26" %}
