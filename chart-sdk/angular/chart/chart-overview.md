...
* [**Multilevel label:**](./axis/axis-labels#multilevel-labels) Supports hierarchical labeling on the axis, allowing grouped or tiered categories for clearer categorization.
...
* [**Export and print:**](./chart-print) Provides options to export the chart to PDF, SVG, PNG, JPEG, CSV, and XLSX formats, and to print the chart.
