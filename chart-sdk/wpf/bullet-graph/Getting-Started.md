...
description: Learn about getting started with the Syncfusion WPF Bullet Graph (SfBulletGraph) control, its elements, and more details.
platform: charts-sdk
...
Right-click the project and select the Syncfusion Reference Manager.

![selecting Syncfusion Reference Manager](Getting-Started_images/Getting-Started_img2.jpeg)

The Syncfusion Reference Manager wizard opens as shown in the figure below.
...
You can assign a caption to the bullet graph by using the [`Caption`](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.BulletGraph.SfBulletGraph.html#Syncfusion_UI_Xaml_BulletGraph_SfBulletGraph_Caption) property, and you can position it either near or far using the [`CaptionPosition`](https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.BulletGraph.SfBulletGraph.html#Syncfusion_UI_Xaml_BulletGraph_SfBulletGraph_CaptionPosition) property.
