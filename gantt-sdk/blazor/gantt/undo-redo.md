...
description: Learn how to enable, configure, and handle undo and redo actions in the Blazor Gantt Chart, including keyboard shortcuts and supported actions.
platform: gantt-sdk
control: Gantt Chart
documentation: ug
---
