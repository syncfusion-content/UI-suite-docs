...
The [Blazor Gantt Chart](https://www.syncfusion.com/blazor-components/blazor-gantt-chart) component supports column reordering by dragging a column header to a new position. 
