...
description: Learn to dynamically edit tasks in Blazor Gantt Chart using cell, dialog, taskbar, or code-based methods for seamless project updates.
platform: gantt-sdk
