...
description: Learn how to configure taskbar labels in the Blazor Gantt Chart component for enhanced data visualization and project management.
platform: gantt-sdk
control:  Task labels
documentation: ug
---
