---
layout: post
title: Style and Appearance in JavaScript Gantt Chart | Syncfusion
...
The following example configures both grid lines:{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/gridline-cs1/index.js %}
{% endhighlight %}
...
- [How to configure timeline?](./timeline/timeline)
- [How to manage columns?](./columns/columns)
