...
{% include code-snippet/gantt-sdk/javascript/gantt-chart/appearanceandstyling-cs1/index.js %}
{% endhighlight %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/appearanceandstyling-cs2/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/change-gripper-icon-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/taskbar-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/customizations-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/customizations-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/projectview-multitaskbar-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/appearanceandstyling-cs3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/gantt-tooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
You can disable the taskbar tooltip using the [beforeTooltipRender](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#beforetooltiprender) event by setting `args.cancel` to **true**.

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/disable-tooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/taskbarTooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/connectorLineTooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/baselineTooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/timelineTooltip-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
To perform touch and hold action on a element, refer to [tooltip popup](https://ej2.syncfusion.com/javascript/documentation/tooltip/es5-getting-started).

## See also

- [How to configure task dependencies?](./task-dependency)
- [How to enable baseline rendering?](./baseline)
- [How to customize labels?](./labels)
