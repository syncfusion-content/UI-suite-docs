...
The Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript Gantt Chart control allows you to resize columns dynamically by dragging the edges of column headers. This feature enhances readability and layout flexibility, especially when working with large datasets. To enable this feature, set the [allowResizing](https://ej2.syncfusion.com/javascript/documentation/api/gantt#allowresizing) property to **true** in the Gantt configuration.
...
> - The [width](https://ej2.syncfusion.com/javascript/documentation/api/gantt/column#width) property of the column can be set initially to define the default width of the column. However, when column resizing is enabled, you can override the default width by manually resizing the columns.
...
To enable this, set the [minWidth](https://ej2.syncfusion.com/javascript/documentation/api/gantt/column#minwidth) and [maxWidth](https://ej2.syncfusion.com/javascript/documentation/api/gantt/column#maxwidth) properties in the column configuration.
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/column-resize-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
The following example demonstrates how to resize a column externally using the [change](https://ej2.syncfusion.com/javascript/documentation/api/drop-down-list#change) event of the [DropDownList](https://ej2.syncfusion.com/javascript/documentation/drop-down-list/es5-getting-started) control

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/column-resize-cs3/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
You can control column resizing using [resizeStart](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#resizestart), [resizing](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#resizing), and [resizeStop](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#resizestop) events.
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/gantt-sdk/javascript/gantt-chart/column-resize-cs4/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
