...
| Module                                                                                   | Description                                          |
| ---------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| [Sort](https://ej2.syncfusion.com/javascript/documentation/api/gantt/sort)               | Inject this module to use sorting feature.           |
| [Filter](https://ej2.syncfusion.com/javascript/documentation/api/gantt/filter)           | Inject this module to use filtering feature.         |
...
| [ContextMenu](https://ej2.syncfusion.com/javascript/documentation/api/gantt/contextMenu) | Inject this module to use context menu feature.      |
| [ColumnMenu](https://ej2.syncfusion.com/javascript/documentation/api/gantt/columnMenu)   | Inject this module to use column menu feature.       |
