...
Export Gantt data as a blob object for previews or modifications by setting the fourth argument of [pdfExport](https://ej2.syncfusion.com/javascript/documentation/api/gantt#pdfexport) to **true**, with the blob returned in the [pdfExportComplete](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#pdfexportcomplete) event.
...
- [How to export to Excel?](../excel-export/)
- [How to customize PDF export?](./customize-pdf-export)
- [How to manage task dependencies?](../managing-tasks/managing-tasks)
