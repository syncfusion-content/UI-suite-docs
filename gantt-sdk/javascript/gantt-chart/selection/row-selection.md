...
You can enable simple multi-row selection by setting the `enableSimpleMultiRowSelection` property to **true** in the Grid configuration during the [created](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#created) event. This allows multiple rows to be selected individually through clicks without holding the Ctrl key.
...
You can customize row selection in the Gantt Chart using [rowSelecting](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#rowselecting), [rowSelected](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#rowselected), [rowDeselecting](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#rowdeselecting), and [rowDeselected](https://help.syncfusion.com/gantt-sdk/javascript/gantt-chart/events#rowdeselected) events, which allow dynamic control over selection behavior based on specific conditions.
