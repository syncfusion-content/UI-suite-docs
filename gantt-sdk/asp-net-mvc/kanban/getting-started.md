...
{% include code-snippet/gantt-sdk/asp-net-mvc/kanban/getting-started/default/razor %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/kanban/getting-started/populating-cards/razor %}
{% endhighlight %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/gantt-sdk/asp-net-mvc/kanban/getting-started/enable-swimlane/razor %}
{% endhighlight %}
{% endtabs %}
