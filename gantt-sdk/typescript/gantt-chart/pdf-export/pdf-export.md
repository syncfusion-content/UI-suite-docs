...
Include dynamic indicators and images in PDF export by defining them with `base64` encoding in the data source, mapped to the [taskFields.indicators](https://ej2.syncfusion.com/documentation/api/gantt/taskFields#indicators) property, enhancing visual representation of task status.
...
Export Gantt data as a blob object for previews or modifications by setting the fourth argument of [pdfExport](https://ej2.syncfusion.com/documentation/api/gantt#pdfexport) to **true**, with the blob returned in the [pdfExportComplete](https://ej2.syncfusion.com/documentation/gantt/events#pdfexportcomplete) event.
...
Export Gantt rows to a single PDF page by setting [fitToWidthSettings.isFitToWidth](https://ej2.syncfusion.com/documentation/api/gantt/fittowidthsettings#isfittowidth) to **true** in `PdfExportProperties`. Customize chart and grid widths using [chartWidth](https://ej2.syncfusion.com/documentation/api/gantt/fittowidthsettings#chartwidth) and [gridWidth](https://ej2.syncfusion.com/documentation/api/gantt/fittowidthsettings#gridwidth) as percentages.
...
Export multiple Gantt instances to a single PDF file by calling [pdfExport](https://ej2.syncfusion.com/documentation/api/gantt#pdfexport) on each, with each Gantt exported to a new page in the same document.
...
Apply themes to exported PDF documents by setting the [theme](https://ej2.syncfusion.com/documentation/api/gantt/pdfexportproperties#theme) property in `PdfExportProperties` to values like Tailwind3, Fabric, Bootstrap, or Bootstrap4, customizing the appearance.
...
- [How to export to Excel?](https://ej2.syncfusion.com/documentation/gantt/excel-export)
- [How to customize PDF export?](https://ej2.syncfusion.com/documentation/gantt/pdf-export/customize-pdf-export)
