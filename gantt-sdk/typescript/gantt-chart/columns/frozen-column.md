...
To enable frozen columns, use the [frozenColumns](https://ej2.syncfusion.com/documentation/api/gantt#frozencolumns) property in the Gantt control.
...
To freeze a particular column in the Gantt, set the [isFrozen](https://ej2.syncfusion.com/documentation/api/gantt/column#isfrozen) property of the column to **true**.
...
To achieve this, the [column.freeze](https://ej2.syncfusion.com/documentation/api/gantt/column#freeze) property can be utilized. This property is used to specify the freeze direction for individual columns.
...
- Freeze Direction is not compatible with the [isFrozen](https://ej2.syncfusion.com/documentation/api/gantt/column#isfrozen) and [frozenColumns](https://ej2.syncfusion.com/documentation/api/gantt#frozencolumns) properties.
