---
layout: post
title: Tree Column in TypeScript Gantt Chart Control | Syncfusion
description: Learn here all about Tree Column in Syncfusion TypeScript Gantt Chart control of Syncfusion Essential JS 2 and more.
platform: gantt-sdk
control: Tree column
...
# Tree Column in TypeScript Gantt Chart Control

The Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control provides a structured way to display parent-child relationships using expand/collapse icons.

To configure this, set the [treeColumnIndex](https://ej2.syncfusion.com/documentation/api/gantt#treecolumnindex) property to the index of the column where these icons should appear. This enables clear visualization and navigation of hierarchical tasks within the Gantt chart.
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control provides support for customizing default expand/collapse icons through CSS.
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control allows customization of the indent space in tree column cells using the [queryCellInfo](https://ej2.syncfusion.com/documentation/gantt/events#querycellinfo) event.
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/tree-column-cs2/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
You can collapse all parent rows during initial rendering by setting the [collapseAllParentTasks](https://ej2.syncfusion.com/documentation/api/gantt#collapseallparenttasks) property in the Gantt Chart control.

{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/tree-column-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
You can retain the expanded or collapsed state of parent rows during initial rendering by using the [expandState](https://ej2.syncfusion.com/documentation/api/gantt/taskFields#expandstate) property in the data source. This property indicates whether a parent row should be expanded or collapsed when the Gantt Chart control loads.

{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/tree-column-cs4/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
To retain the expanded and collapsed state of rows after a page refresh in the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control:

1. Use the [collapsed](https://ej2.syncfusion.com/documentation/api/gantt#collapsed) event to store the collapsed row's primary key in `localStorage` via [setItem](https://developer.mozilla.org/en-US/docs/Web/API/Storage/setItem).
2. On page reload, retrieve the stored keys in the [dataBound](https://ej2.syncfusion.com/documentation/api/gantt/index-default#databound) event using [getItem](https://developer.mozilla.org/en-US/docs/Web/API/Storage/getItem).
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control provides built-in methods to programmatically control row expansion and collapse:

- **[expandAll()](https://ej2.syncfusion.com/documentation/api/gantt#expandall)**: Expands all rows.

```ts
gantt.expandAll();
```

- **[collapseAll()](https://ej2.syncfusion.com/documentation/api/gantt#collapseall)**: Collapses all rows.
...
To retrieve the currently expanded rows in the Gantt Chart control, use the [getExpandedRecords](https://ej2.syncfusion.com/documentation/api/gantt#getexpandedrecords) method.

{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/gantt-sdk/typescript/gantt-chart/tree-column-cs7/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
You can customize expand and collapse behavior in the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control using the [expanding](https://ej2.syncfusion.com/documentation/gantt/events#expanding), [expanded](https://ej2.syncfusion.com/documentation/gantt/events#expanded), [collapsing](https://ej2.syncfusion.com/documentation/api/gantt#collapsing), and [collapsed](https://ej2.syncfusion.com/documentation/api/gantt#collapsed) events. These events allow you to control and respond to row state changes programmatically based on your application logic.

The following sample demonstrates how to customize expand and collapse actions in the Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control:
