...
In Syncfusion<sup style="font-size:70%">&reg;</sup> TypeScript Gantt Chart control, columns are reordered by default. To restrict reordering for a specific column, set its [allowReordering](../../api/gantt/column#allowreordering) property to **false**.  
