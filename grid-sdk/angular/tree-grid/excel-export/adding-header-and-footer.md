...
{% include code-snippet/grid-sdk/angular/tree-grid/excel-export-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/tree-grid/excel-export-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
