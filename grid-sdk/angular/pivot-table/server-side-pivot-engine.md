---
layout: post
title: Server side pivot engine in Angular Pivotview component | Syncfusion
description: Learn here all about Server side pivot engine in Syncfusion Angular Pivotview component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
This section explains how to set up and use different data sources with the server-side Pivot Engine in the Angular [Pivot Table](https://ej2.syncfusion.com/angular/documentation/pivotview/getting-started).
...
export class AppComponent implements OnInit {
  ...
  public button?: Button;
    ...
    ngOnInit(): void {
        ...
        this.button.element.onclick = (): void => {
            this.pivotGridObj?.exportAsPivot();
        };
    }
}
...
The Pivot Table exposes a hook for every outgoing call through the [`beforeServiceInvoke`](https://ej2.syncfusion.com/angular/documentation/api/pivotview/beforeserviceinvokeeventargs) event. The event fires just before a request is sent and provides an **args** object, allowing headers to be set via `args.internalProperties.headers`. Using [`beforeServiceInvoke`](https://ej2.syncfusion.com/angular/documentation/api/pivotview/beforeserviceinvokeeventargs) avoids endpoint rewrites or custom transports and provides a single reliable hook that applies to aggregation, sorting, filtering, grouping, exporting, and more.
...
{% include code-snippet/grid-sdk/angular/pivot-table/angular/pivot-table/angular/pivot-table/server-side-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/pivot-table/angular/pivot-table/angular/pivot-table/server-side-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "https://help.syncfusion.com/samples/grid-sdk/angular/pivot-table/help.syncfusion.com/samples/grid-sdk/angular/pivot-table/help.syncfusion.com/samples/grid-sdk/angular/pivot-table/server-side-cs1" %}
...
- Missing headers: Ensure [`beforeServiceInvoke`](https://ej2.syncfusion.com/angular/documentation/api/pivotview/beforeserviceinvokeeventargs) runs on the same Pivot instance and sets headers on every call.
