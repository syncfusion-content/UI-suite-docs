...
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs1/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="locale.json" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs1/src/locale.json %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample https://help.syncfusion.com/samples/grid/localization-cs1 %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs5/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="locale.json" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs5/src/locale.json %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs5/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample https://help.syncfusion.com/samples/grid/localization-cs5 %}

### Switch the different localization

The Angular Data Grid supports switching localization between cultures, allowing dynamic changes based on application requirements.
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs6/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="locale.json" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs6/src/locale.json %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs6/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample https://help.syncfusion.com/samples/grid/localization-cs6 %}

### Set different locale text for two Grids in same page

The Angular Data Grid allows configuring different [locale](https://ej2.syncfusion.com/angular/documentation/api/grid#locale) settings for multiple Grids displayed on the same page. By using the `L10n.load` function to define translations for specific languages so each Grid applies the appropriate localized text for headers, toolbar items, and action buttons.
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs2/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="locale.json" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs2/src/locale.json %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/localization-cs2/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample https://help.syncfusion.com/samples/grid/localization-cs2 %}
...
{% tabs %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/paging1-cs1/src/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="locale.json" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/paging1-cs1/src/locale.json %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/grid-sdk/angular/data-grid/angular/data-grid/angular/data-grid/paging1-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample https://help.syncfusion.com/samples/grid/paging1-cs1 %}
