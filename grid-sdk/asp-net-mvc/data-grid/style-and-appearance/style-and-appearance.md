...
# Style and appearance in ASP.NET MVC Grid component
...
4. Once done, you can download the generated CSS file and include it in your ASP.NET MVC project.

## Customizing the grid root element

To customize the appearance of the root element of the Syncfusion ASP.NET MVC Grid component, you can use CSS. Here's an example of how to modify the font family and row colors using CSS:
...
The above code snippet, the **.e-grid** class targets the root element of the Syncfusion ASP.NET MVC Grid component, and the `font-family` property is set to cursive to change the font family of the grid content.
