---
layout: post
title: Adding Header and Footer in ASP.NET MVC Grid Component
description: Learn here all about Adding Header and Footer in Syncfusion ASP.NET MVC Grid component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
