...
{% include code-snippet/grid-sdk/asp-net-mvc/data-grid/data-annotation/annotation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/data-grid/data-annotation/annotation/annotation.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/data-grid/data-annotation/annotation/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Annotation.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/data-grid/data-annotation/annotation/annotation.cs %}
{% endhighlight %}
