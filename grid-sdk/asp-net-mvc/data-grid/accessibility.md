---
layout: post
title: Accessibility in Syncfusion ASP.NET MVC Grid Component
description: Learn here all about Accessibility in Syncfusion ASP.NET MVC Grid component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
The Syncfusion ASP.NET MVC Grid provides flexibility to prevent the default key action behavior based on your requirements. This enables you to intercept and customize the behavior when specific keys are pressed within a web application
...
The Syncfusion ASP.NET MVC Grid component enables you to enhance the usability of keyboard shortcuts for various grid actions and navigation. In addition to the built-in keyboard navigation capabilities, you can implement custom keyboard shortcuts to execute specific actions.
...
You can add more custom shortcuts and actions as needed to enhance the functionality of your Syncfusion ASP.NET MVC Grid component.
