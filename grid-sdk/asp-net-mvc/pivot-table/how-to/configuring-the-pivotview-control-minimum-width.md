---
layout: post
title: Minimum width configuration in Syncfusion ASP.NET MVC Pivot Table
description: Learn all about configuring the minimum width in the Syncfusion ASP.NET MVC Pivot Table control of syncfusion and more.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/min-width/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="MinWidth.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/min-width/MinWidth.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/min-width/razor %}
{% endhighlight %}
{% highlight c# tabtitle="MinWidth.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/min-width/MinWidth.cs %}
{% endhighlight %}
