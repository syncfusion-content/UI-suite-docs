---
layout: post
title: Apply custom styles for cells in Syncfusion ASP.NET MVC Pivot Table
description: Learn here all about Apply custom style to pivot cells in Syncfusion ASP.NET MVC Pivot Table component of syncfusion and more.
platform: grid-sdk
...
# Apply custom style to pivot cells in ASP.NET MVC Pivot Table
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/apply-custom-styles/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="CustomStyles.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/apply-custom-styles/CustomStyles.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/apply-custom-styles/razor %}
{% endhighlight %}
{% highlight c# tabtitle="CustomStyles.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/apply-custom-styles/CustomStyles.cs %}
{% endhighlight %}
