---
layout: post
title: Getting Started with ASP.NET MVC Pivot Table Control | Syncfusion
description: Checkout and learn about getting started with ASP.NET MVC Pivot Table control of Syncfusion Essential JS 2 and more details.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/getting-start-mvc/pivot-table/razor %}
{% endhighlight %}
{% highlight c# tabtitle="HomeController.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/getting-start-mvc/pivot-table/pivottable.cs %}
{% endhighlight %}
{% endtabs %}
