...
description: Learn here all about Css Customization in Syncfusion ASP.NET MVC Pivot Table component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
# CSS customization in ASP.NET MVC Pivot Table component
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-axis/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Axis.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-axis/axis.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-axis/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Axis.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-axis/axis.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-align/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Text-align.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-align/text-align.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-align/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Text-align.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-align/text-align.cs %}
{% endhighlight %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-pivot/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Axis.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-pivot/axis.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-pivot/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Axis.cs" %}
{% include code-snippet/grid-sdk/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/asp-net-mvc/pivot-table/css-pivot/axis.cs %}
{% endhighlight %}
