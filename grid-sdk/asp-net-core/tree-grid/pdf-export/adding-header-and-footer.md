...
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/asp-net-core/tree-grid/asp-net-core/tree-grid/pdf-export/insert-image/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Insert-image.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/asp-net-core/tree-grid/asp-net-core/tree-grid/pdf-export/insert-image/insert-image.cs %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/asp-net-core/tree-grid/asp-net-core/tree-grid/pdf-export/insert-image/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Insert-image.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/tree-grid/asp-net-core/tree-grid/asp-net-core/tree-grid/pdf-export/insert-image/insert-image.cs %}
{% endhighlight %}
