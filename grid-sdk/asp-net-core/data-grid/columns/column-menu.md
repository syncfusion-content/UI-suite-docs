---
layout: post
title: Column Menu in Syncfusion ASP.NET Core Grid Component
description: Learn here all about Column Menu in Syncfusion ASP.NET Core Grid component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
control: Column Menu
...
The ASP.NET Core Grid provides the ability to prevent the appearance of the column menu for specific columns. This feature is useful when you want to restrict certain columns from being customizable through the column menu.
