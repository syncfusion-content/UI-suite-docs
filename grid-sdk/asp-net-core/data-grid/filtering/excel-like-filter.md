---
layout: post
title: Excel Like Filter in Syncfusion ASP.NET Core Grid 
description: Learn here all about Excel Like Filter in Syncfusion ASP.NET Core Grid of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-checkbox/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-checkbox/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-choice-count/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-choice-count/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-show-customized-text/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-show-customized-text/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-show-template/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-show-template/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-customize-dialog/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-customize-dialog/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-custom-datasource/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-custom-datasource/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-hide-sorting/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-hide-sorting/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-animation/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="excelfilter.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/filtering/excelfilter-animation/excelfilter.cs %}
{% endhighlight %}
{% endtabs %}
