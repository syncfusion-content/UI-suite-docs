...
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hierarchy-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Childgrid.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hierarchy-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hierarchy-grid-different-field/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Different-field.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hierarchy-grid-different-field/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/expand-child-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Expand.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/expand-child-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/dynamically-load-child-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Load.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/dynamically-load-child-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/dynamically-bind-data/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Dynamicbind.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/dynamically-bind-data/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/add-record-child-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="AddRecord.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/add-record-child-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/template-column-child-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Templategrid.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/template-column-child-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/get-parent-grid-details/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Parent-detail.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/get-parent-grid-details/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/aggregates-child-grid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Aggregates.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/aggregates-child-grid/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/expand-collapse-externally/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="External-expand.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/expand-collapse-externally/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hide-expand-icon/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Expandicon.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/hide-expand-icon/html.cs %}
{% endhighlight %}
{% endtabs %}
...
The Data Grid component provides built-in expand/collapse icons for hierarchical Grid. However, you can customize these icons using custom CSS to modify their visual representation.
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/customize-icon/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/customize-icon/html.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight cshtml tabtitle="CSHTML" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/detail-row-events/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="Html.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/hierarchy-grid/detail-row-events/html.cs %}
{% endhighlight %}
{% endtabs %}
...
![Customize the child Grid header cell in ASP.NET Core.](images/hierarchy-grid/grid-child-header-cell.png)
...
![ASP.NET Core Grid pager container element.](images/hierarchy-grid/grid-child-pager-container-element.png)
...
![ASP.NET Core Grid current pager numeric element.](images/hierarchy-grid/grid-child-current-page-numeric-element.png)

### Sorting

You can customize the appearance of the sorting icons and multi sorting icons in the child grid using CSS.You can use the available Syncfusion<sup style="font-size:70%">&reg;</sup> [icons](https://ej2.syncfusion.com/aspnetcore/documentation/appearance/icons#material) based on your theme. Here's how to do it:
...
![ASP.NET Core Grid filter bar cell element.](images/hierarchy-grid/grid-child-filter-bar-cell-element.png)
...
![ASP.NET Core Grid filter dialog content.](images/hierarchy-grid/grid-child-filter-dialog-content.png)
...
![ASP.NET Core Grid filter dialog footer.](images/hierarchy-grid/child-grid-filter-dialog-footer.png)
...
![ASP.NET Core Grid filter dialog input element.](images/hierarchy-grid/grid-child-filter-dialog-input-element.png)
...
![ASP.NET Core Grid filter dialog button element.](images/hierarchy-grid/grid-child-filter-dialog-button-element.png)
...
![ASP.NET Core Grid excel filter dialog number filters element.](images/hierarchy-grid/grid-child-excel-filter-dialog-element.png)
...
![Child Grid group header in ASP.NET Core.](images/hierarchy-grid/grid-child-group-header.png)
...
![Child Grid customizing the added row element in ASP.NET Core.](images/hierarchy-grid/child-grid-added-row-element.png)
...
![Child ASP.NET Core Grid edited row input element in dialog.](images/hierarchy-grid/child-grid-edited-row-input-element-in-dialog.png)
...
![Child Grid customize command column button in ASP.NET Core.](images/hierarchy-grid/child-grid-command-button.png)
...
![Child Grid customize aggregate cell element in ASP.NET Core.](images/hierarchy-grid/child-grid-aggregate-cell-element.png)
...
![Child Grid cell selection in ASP.NET Core.](images/hierarchy-grid/child-grid-column-selection.png)