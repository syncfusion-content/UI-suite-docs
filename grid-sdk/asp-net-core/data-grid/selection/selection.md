---
layout: post
title: Selection in ASP.NET Core Grid Control | Syncfusion
description: Learn here all about Selection in Syncfusion ASP.NET Core Grid component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
control: Selection
...
# Selection in ASP.NET Core Grid component
...
To disable selection in the Grid, set the [allowSelection](https://help.syncfusion.com/cr/aspnetcore-js2/syncfusion.ej2.grids.grid.html#Syncfusion_EJ2_Grids_Grid_AllowSelection) to **false**.
...
To enable selection mode, you can set the [selectionSettings.mode](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Grids.GridSelectionSettings.html#Syncfusion_EJ2_Grids_GridSelectionSettings_Mode) property. The Grid component supports three types of selection modes:
...
> For multi-selection, it requires the selection [type](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Grids.GridSelectionSettings.html#Syncfusion_EJ2_Grids_GridSelectionSettings_Type) to be **Multiple**.
...
To enable the toggle selection feature, you need to set the [selectionSettings.enableToggle](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Grids.GridSelectionSettings.html#Syncfusion_EJ2_Grids_GridSelectionSettings_EnableToggle) property to **true**.
...
To enable persist selection, set the [selectionSettings.persistSelection](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Grids.GridSelectionSettings.html#Syncfusion_EJ2_Grids_GridSelectionSettings_PersistSelection) property to **true**.
...
>* The `persistSelection` feature is not supported for cell selections in the Syncfusion ASP.NET Core Grid component.
