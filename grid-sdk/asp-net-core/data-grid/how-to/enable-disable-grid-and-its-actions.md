...
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/how-to/disablegrid/tagHelper %}
{% endhighlight %}
{% highlight c# tabtitle="disablegrid.cs" %}
{% include code-snippet/grid-sdk/asp-net-core/data-grid/asp-net-core/data-grid/asp-net-core/data-grid/how-to/disablegrid/disablegrid.cs %}
{% endhighlight %}
{% endtabs %}
