...
description: Learn here all about Customizing loading indicator in Syncfusion TypeScript Pivot Table component of Syncfusion Essential JS 2 and more.
platform: grid-sdk
...
{% include code-snippet/grid-sdk/typescript/pivot-table/typescript/pivot-table/typescript/pivot-table/pivot-table-cs78/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/typescript/pivot-table/typescript/pivot-table/typescript/pivot-table/pivot-table-cs78/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "https://help.syncfusion.com/code-snippet/grid-sdk/typescript/pivot-table/help.syncfusion.com/code-snippet/grid-sdk/typescript/pivot-table/help.syncfusion.com/code-snippet/grid-sdk/typescript/pivot-table/pivot-table-cs78" %}

{% elsif page.publishingplatform == "javascript" %}

{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/grid-sdk/typescript/pivot-table/typescript/pivot-table/typescript/pivot-table/pivot-table-cs78/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/grid-sdk/typescript/pivot-table/typescript/pivot-table/typescript/pivot-table/pivot-table-cs78/index.html %}
{% endhighlight %}
